...
export default function Home() {
  return (
    <div className="w-full h-full">
      ...
      <div className="w-full h-screen relative bg-gradient-to-t from-blue-500 to-pink-500" >
        <img
          src="./img/PlanoDeFundo.jpg"
          className="h-screen w-full inset-0 absolute opacity-25"
          alt="Wallpaper"
        />
        <div className=" w-full relative h-full isolate overflow-hidden px-6 pt-16 sm:px-16 md:pt-24 lg:flex lg:px-24 lg:pt-0"> 
          <div className="w-full mx-auto md:max-w-lg text-center lg:mx-0 lg:py-32 lg:text-left text-slate-200">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-6xl">
              A música que toca corações, chega a milhões!
            </h2>
            <p className="w-4/5 my-6 text-xl font-bold tracking-tight sm:text-4xl md:text-3xl">
